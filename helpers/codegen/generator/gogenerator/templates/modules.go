...
// isModuleCode, isStandaloneClient and moduleRelPath live in client.go, shared
// with the client path. Dependencies/HasLocalDependencies are not ported: a
// standalone client here serves one BoundModule, so nothing renders them.
